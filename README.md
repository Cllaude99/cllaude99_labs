...
**Turborepo 모노레포** 구조로 구성되어 있으며, 여러 애플리케이션과 공유 패키지를 포함하고 있습니다.
...
- **포트**: 3000
- **설명**: 개인 개발 공간은 [cllaude99_labs](https://www.cllaude99-labs.com/)에서 확인해볼 수 있습니다.
...
> 🎯 CLAUDE code의 공식문서를 참고하여 정리하였습니다.
