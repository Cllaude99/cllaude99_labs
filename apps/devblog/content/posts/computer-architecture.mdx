...
이번 글에서는 컴퓨터의 하드웨어 구조와 동작 원리를 간단하게 정리해보겠습니다. CPU의 구성 요소부터 메모리 계층, 데이터 표현 방식, 그리고 오류 처리 메커니즘까지 살펴보면서 컴퓨터 하드웨어의 구성과 동작원리를 알아보겠습니다.
...
graph TB
    ...
    style CPU fill:#e3f2fd,color:#1a1a1a
    style Memory fill:#fff3e0,color:#1a1a1a
    style IO fill:#f3e5f5,color:#1a1a1a
    style Bus fill:#c5e1a5,color:#1a1a1a
    style OS fill:#ffccbc,color:#1a1a1a
    style Compiler fill:#ffccbc,color:#1a1a1a
    style Apps fill:#ffccbc,color:#1a1a1a
```
...
graph LR
    ...
    style DataBus fill:#c5e1a5,color:#1a1a1a
    style AddressBus fill:#fff59d,color:#1a1a1a
    style ControlBus fill:#ef9a9a,color:#1a1a1a
```
...
graph TB
    ...
    style CU fill:#e3f2fd,color:#1a1a1a
    style ALU fill:#fff3e0,color:#1a1a1a
    style Registers fill:#f3e5f5,color:#1a1a1a
```
...
graph LR
    ...
    style C fill:#ffcc80,color:#1a1a1a
    style D fill:#ef9a9a,color:#1a1a1a
```
...
graph LR
    ...
    style CPU fill:#e3f2fd,color:#1a1a1a
    style RAM fill:#fff3e0,color:#1a1a1a
...
graph TB
    ...
    style L1 fill:#c5e1a5,color:#1a1a1a
    style L2 fill:#fff59d,color:#1a1a1a
    style L3 fill:#ffcc80,color:#1a1a1a
    style RAM fill:#ef9a9a,color:#1a1a1a
```
...
graph TB
    ...
    style Hit fill:#c5e1a5,color:#1a1a1a
    style Miss fill:#ef9a9a,color:#1a1a1a
```
...
graph LR
    ...
    style Data fill:#c5e1a5,color:#1a1a1a
    style WithParity fill:#fff59d,color:#1a1a1a
    style Error fill:#ef9a9a,color:#1a1a1a
```
...
graph TB
    ...
    style Send fill:#c5e1a5,color:#1a1a1a
    style Receive fill:#fff59d,color:#1a1a1a
    style Fix fill:#ffcc80,color:#1a1a1a
    style Success fill:#c5e1a5,color:#1a1a1a
```
