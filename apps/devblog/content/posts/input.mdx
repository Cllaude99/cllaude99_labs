...
graph TB
    ...
    style TCP fill:#fff59d
    style IP fill:#ffcc80
    style Frame fill:#c5e1a5
```
...
graph LR
    ...
    style PC fill:#c5e1a5
    style Server fill:#ef9a9a
```
