...
graph LR
    ...
    style B fill:#e3f2fd,color:#1a1a1a
    style C fill:#c5e1a5,color:#1a1a1a
```
...
graph TB
    ...
    style Code fill:#c5e1a5,color:#1a1a1a
    style Data fill:#fff59d,color:#1a1a1a
    style Heap fill:#ffcc80,color:#1a1a1a
    style Stack fill:#ef9a9a,color:#1a1a1a
```
...
graph TB
    ...
    style Process1 fill:#e3f2fd,color:#1a1a1a
    style Process2 fill:#fff3e0,color:#1a1a1a
```
...
graph TB
    ...
    style Shared fill:#c5e1a5,color:#1a1a1a
    style Thread1 fill:#fff59d,color:#1a1a1a
    style Thread2 fill:#ffcc80,color:#1a1a1a
    style Thread3 fill:#ef9a9a,color:#1a1a1a
```
...
프로세스는 독립적인 메모리 공간을 가지므로, 기본적으로 다른 프로세스의 메모리에 접근할 수 없습니다.
이는 안정성을 제공하지만, 프로세스 간 데이터 공유가 어렵다는 특징이 있습니다.
( 이후에 다루겠지만 익명 파이프, Named Pipe, 공유 메모리 등의 IPC 개념을 통해 다른 프로세스와 데이터를 공유할 수 있습니다.)
...
이러한 멀티프로세스의 단점을 보완하기 위해서는 공유 메모리를 활용하거나 프로세스 개수를 적절하게 설정하여 Context Switching을 최소화 할 수 있습니다.
...
이러한 멀티스레드의 단점을 보완하기 위해서는 뮤텍스(Mutex), 세마포어(Semaphore)를 사용할 수 있습니다.
...
graph TB
    ...
    style MultiProcess fill:#e3f2fd,color:#1a1a1a
    style MultiThread fill:#fff3e0,color:#1a1a1a
```
...
graph TB
    ...
    style Pipe fill:#c5e1a5,color:#1a1a1a
    style NamedPipe fill:#fff59d,color:#1a1a1a
    style SharedMemory fill:#ffcc80,color:#1a1a1a
    style MessageQueue fill:#ef9a9a,color:#1a1a1a
    style Socket fill:#e3f2fd,color:#1a1a1a
```
...
즉, 두 개 이상의 프로세스가 공유 자원에 동시에 접근하여 실행 순서에 따라 결과가 달라지는 상황이 발생할 수 있습니다.
...
graph TB
    ...
    style CS1 fill:#c5e1a5,color:#1a1a1a
    style Wait fill:#ef9a9a,color:#1a1a1a
    style CS2 fill:#c5e1a5,color:#1a1a1a
```
...
graph TB
    ...
    style Start fill:#c5e1a5,color:#1a1a1a
    style Interrupt fill:#fff59d,color:#1a1a1a
    style ISR fill:#ffcc80,color:#1a1a1a
    style Continue fill:#c5e1a5,color:#1a1a1a
```
...
graph TB
    ...
    style Hardware fill:#e3f2fd,color:#1a1a1a
    style Software fill:#fff3e0,color:#1a1a1a
```
...
graph TB
    ...
    style UserMode fill:#e3f2fd,color:#1a1a1a
    style KernelMode fill:#fff3e0,color:#1a1a1a
    style Hardware fill:#c5e1a5,color:#1a1a1a
```
...
graph TB
    ...
    style ZChild fill:#ef9a9a,color:#1a1a1a
    style OChild fill:#fff59d,color:#1a1a1a
    style Init fill:#c5e1a5,color:#1a1a1a
```
...
graph TB
    ...
    style PID fill:#c5e1a5,color:#1a1a1a
    style State fill:#fff59d,color:#1a1a1a
    style PC fill:#ffcc80,color:#1a1a1a
    style Registers fill:#ef9a9a,color:#1a1a1a
```
...
graph TB
    ...
    style Start fill:#c5e1a5,color:#1a1a1a
    style Save fill:#fff59d,color:#1a1a1a
    style Schedule fill:#ffcc80,color:#1a1a1a
    style Load fill:#ef9a9a,color:#1a1a1a
    style Run fill:#c5e1a5,color:#1a1a1a
```
...
graph TB
    ...
    style NonPreemptive fill:#e3f2fd,color:#1a1a1a
    style Preemptive fill:#fff3e0,color:#1a1a1a
```
...
graph TB
    ...
    style P1 fill:#ef9a9a,color:#1a1a1a
    style P2 fill:#ef9a9a,color:#1a1a1a
...
graph TB
    ...
    style Problem fill:#fff3e0,color:#1a1a1a
    style Note fill:#ef9a9a,color:#1a1a1a
```
...
graph TB
    ...
    style I2 fill:#ef9a9a,color:#1a1a1a
    style E2 fill:#ef9a9a,color:#1a1a1a
    style E4 fill:#ef9a9a,color:#1a1a1a
    style Note fill:#fff9c4,color:#1a1a1a
```
...
graph LR
    ...
    style Logical fill:#e3f2fd,color:#1a1a1a
    style PageTable fill:#fff59d,color:#1a1a1a
    style Physical fill:#c5e1a5,color:#1a1a1a
```
...
graph LR
    ...
    style Logical fill:#e3f2fd,color:#1a1a1a
    style SegTable fill:#fff59d,color:#1a1a1a
    style Physical fill:#c5e1a5,color:#1a1a1a
```
...
graph LR
    ...
    style Program fill:#e3f2fd,color:#1a1a1a
    style Seg fill:#fff59d,color:#1a1a1a
    style Page fill:#ffcc80,color:#1a1a1a
    style Physical fill:#c5e1a5,color:#1a1a1a
```
