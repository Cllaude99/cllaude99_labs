...
description: Provide quick code review feedback following CLAUDE.md principles. Use when user asks "이 코드 어때?", "리뷰해줘", "문제 없어?", "개선할 점은?" or shares code requesting feedback. For detailed file-based review, recommend /review command.
---
...
- **Command 참조**: `@.claude/commands/review.md`
- **프로젝트 가이드**: `@CLAUDE.md`
